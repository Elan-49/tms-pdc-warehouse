...
function renderObserve(){
  ...
  function setObserveMethodUI(method){
    ...
    if($('#observationInputTitle'))$('#observationInputTitle').textContent=isManual?'Manual Observation':'Video Observation';
